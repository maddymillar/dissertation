...
DEFINE kalpha (judges = !charend ('/')/level = !charend('/') !default(1)/detail = !charend('/') !default(0)/boot = !charend('/') !default(0)/seed=!charend('/') !default(random)).
PRESERVE.
...
KALPHA judges = Coder_1 Coder_2/level=1/detail=1/boot=10000
